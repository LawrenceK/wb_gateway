...
# $Id$
#
# Unit testing for HTTP Simplex event router functions
#
...
# Tom Bushby
#
# The Simplex test is when the Client of a HTTP Server
# pushes data and events through the HTTP server which are
# then forwarded to the main router. The Simplex connections
# cannot send data to the Client from the HTTP Server, it must come
# from a router.
...
# Test class
class TestEventRouterHTTPSimplex(unittest.TestCase):
    ...
    def tearDown(self):
        Trace("TearDown", "TestEventRouterHTTPSimplex")
    ...
    def setUpRouter(self):
        ...
        #
        # Wildcard event
        self.R1.routeEventFrom(evtype="R9Events/ev1",router=self.R2)
        self.R3C.routeEventFrom(evtype="R9Events/ev1",router=self.R1)        
        self.R2C.routeEventFrom(evtype="R1Events/ev1",router=self.R1)
        self.R3C.routeEventFrom(evtype="R1Events/ev1",router=self.R1)
        
        # Wildcard source       
        self.R1.routeEventFrom(source="R10Source/src1",router=self.R2)
        self.R3C.routeEventFrom(source="R10Source/src1",router=self.R1)  
        self.R2C.routeEventFrom(source="R1Source/src1",router=self.R1)
        self.R3C.routeEventFrom(source="R1Source/src1",router=self.R1)
        
        # No wildcards
        self.R1.routeEventFrom(evtype="R11Events/ev1",source="R11Source/src1",router=self.R2)
        self.R3C.routeEventFrom(evtype="R11Events/ev1",source="R11Source/src1",router=self.R1)  
        self.R2C.routeEventFrom(evtype="R1Events1/ev1",source="R1Source1/src1",router=self.R1)       
        self.R3C.routeEventFrom(evtype="R1Events1/ev1",source="R1Source1/src1",router=self.R1)
        
        # Cross routing event
        self.R1.routeEventFrom(evtype="RREvents2/ev1",source="RRSource2/src1",router=self.R2)##
        self.R2C.routeEventFrom(evtype="RREvents2/ev1",source="RRSource2/src1",router=self.R1)##
        self.R1.routeEventFrom(evtype="RREvents3/ev1",source="RRSource3/src1",router=self.R3)##
        self.R3C.routeEventFrom(evtype="RREvents3/ev1",source="RRSource3/src1",router=self.R1)##
        
        # 3-way loop routing event
        self.R1.routeEventFrom(evtype="RREvents12/ev1",source="RRSource12/src1",router=self.R2)
        self.R2C.routeEventFrom(evtype="RREvents12/ev1",source="RRSource12/src1",router=self.R3)
        self.R3C.routeEventFrom(evtype="RREvents12/ev1",source="RRSource12/src1",router=self.R1)
    ...
    def doSubscriptionForwarding(self, r1, r2, evtype, source, evmatch, evdrop, 
        ...
        Info("--do-subscription-forwarding start", "TestEventRouterHTTPSimplex")
    ...
    def doSubscriptionForwardingR3R1(self, evtype, source, evmatch, evdrop, r1fwd=0):
        self.setUpRouter()
        self.doSubscriptionForwarding(self.R3C, self.R1, evtype, source, evmatch, evdrop, 
            r1fwd=r1fwd, r1rtr=self.R3C, delay=0.1)
        return        
    ...
    def doSubscriptionForwardingR2R1(self, evtype, source, evmatch, evdrop, r1fwd=0):
        ...
        self.doSubscriptionForwarding(self.R2C, self.R1, evtype, source, evmatch, evdrop, 
            r1fwd=r1fwd, r1rtr=self.R2C, delay=0.1)
        return
    ...
    def doSubscriptionForwardingR2R3(self, evtype, source, evmatch, evdrop, r1fwd=0):
        self.setUpRouter()
        self.doSubscriptionForwarding(self.R3C, self.R2C, evtype, source, evmatch, evdrop, 
            r1fwd=r1fwd, r1rtr=self.R2C, delay=0.1)
        return
    ...
    def testTestEventRouterHTTPIntro(self):
        Info("---- testTestEventRouterHTTPIntro: TestEventRouterHTTP component tests take about 100s to run","TestEventRouterHTTPSimplex")
    ...
    def testSubscriptionForwarding9(self):
        Info("---- testSubscriptionForwarding9 ----","TestEventRouterHTTPSimplex")
        evmatch = makeEvent(evtype="R9Events/ev1",source="R9Source/src1")
        evdrop  = makeEvent(evtype="R9Events/ev2",source="R9Source/src2")
        self.doSubscriptionForwardingR2R3("R9Events/ev1", None, evmatch, evdrop)
        return

    # Test 2-hop routing based on event source matching
    def testSubscriptionForwarding10(self):
        Info("---- testSubscriptionForwarding10 ----","TestEventRouterHTTPSimplex")
        evmatch = makeEvent(evtype="R10Events/ev1",source="R10Source/src1")
        evdrop  = makeEvent(evtype="R10Events/ev2",source="R10Source/src2")
        self.doSubscriptionForwardingR2R3(None, "R10Source/src1", evmatch, evdrop)
        return

    # Test 2-hop routing based on event type and source matching
    def testSubscriptionForwarding11(self):
        Info("---- testSubscriptionForwarding11 ----","TestEventRouterHTTPSimplex")
        evmatch = makeEvent(evtype="R11Events/ev1",source="R11Source/src1")
        evdrop  = makeEvent(evtype="R11Events/ev2",source="R11Source/src2")
        self.doSubscriptionForwardingR2R3("R11Events/ev1", "R11Source/src1", evmatch, evdrop)
        return

    # Test 2-hop subscription loop doesn't cause routing loop
    def testSubscriptionForwarding12(self):
        Info("---- testSubscriptionForwarding12 ----","TestEventRouterHTTPSimplex")
        evmatch = makeEvent(evtype="RREvents12/ev1",source="RRSource12/src1")
        evdrop  = makeEvent(evtype="RREvents12/ev2",source="RRSource12/src2")
        self.doSubscriptionForwardingR2R3("RREvents12/ev1", "RRSource12/src1", evmatch, evdrop, r1fwd=1)
        return

    # Done
    def testTestEventRouterHTTPDone(self):
        Info("---- testTestEventRouterHTTPDone TestEventRouterHTTP component tests done ----","TestEventRouterHTTPSimplex")
...
def getTestSuite(select="unit"):
    ...
    return TestUtils.getTestSuite(TestEventRouterHTTPSimplex, testdict, select=select)

# Run unit tests directly from command line
if __name__ == "__main__":
    TestUtils.runTests("TestEventRouterHTTPSimplex.log", getTestSuite, sys.argv)
