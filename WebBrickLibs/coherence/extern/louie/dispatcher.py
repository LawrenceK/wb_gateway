...
_log = logging.getLogger( "louie.dispatcher" )
...
def send(signal=All, sender=Anonymous, *arguments, **named):
    ...
    """
#    _log.debug( "send %s %s %s %s", signal, sender, arguments, named)
    _log.debug( "send %s %s", signal, sender)
#    _log.debug( "send signal %s", signal)
#    _log.debug( "send sender %s", sender)
#    _log.debug( "send arguments %s", arguments)
#    _log.debug( "send named %s", named)
