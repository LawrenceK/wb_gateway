...
<html py:layout="'sitelayout3.kid'" xmlns:py="http://purl.org/kid/ns#"  xmlns:wb="http://id.webbrick.co.uk/" 
    ...
    <div py:match="item.tag == '{http://id.webbrick.co.uk/}topboxcontent'" id="topboxcontent">
        ...
        <table>
            ...
            <tr>
                <td colspan="2" style="margin-left:5px; text-align:left"><h1>Gateway Reboot</h1></td>
            </tr>
            <tr>
                <th>&nbsp;</th>
            </tr>
            <tr>
                <td colspan="3">
                    <div style="margin-left:16px; text-align:left ">
                        Warning! Pressing the reboot button below will initiate a reboot of your Gateway Appliance. 
                        A reboot is likely to take multiple minutes, during which the gateway will not be accessible. 
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <wb:simpleButton 
                            wbTarget="/sendevent/from_ui/command/gateway/reboot">
                        REBOOT
                    </wb:simpleButton>
                </td>
                <td>
