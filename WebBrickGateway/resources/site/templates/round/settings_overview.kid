...
<html py:layout="'sitelayout3.kid'" xmlns:py="http://purl.org/kid/ns#"  xmlns:wb="http://id.webbrick.co.uk/" 
    ...
    <div py:match="item.tag == '{http://id.webbrick.co.uk/}topboxcontent'" id="topboxcontent">
        ...
        <table>
            ...
            <tr>
                <td colspan="2" style="margin-left:5px; text-align:left"><h1>Gateway Settings</h1></td>
            </tr>
            <tr>
                <th>&nbsp;</th>
            </tr>
            <tr>
                <td colspan="3">
                    <div style="margin-left:16px; text-align:left ">
                        You have entered the Gateway Settings pages, please select one of the setting options from the menu on the left. 
                    </div>
                </td>
            </tr>
        </table>
