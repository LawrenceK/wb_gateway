...
<html py:layout="'sitelayout3.kid'" xmlns:py="http://purl.org/kid/ns#"  xmlns:wb="http://id.webbrick.co.uk/" 
    ...
    <div py:match="item.tag == '{http://id.webbrick.co.uk/}topboxcontent'" id="topboxcontent">
        ...
        <table>
            ...
            <tr>
                <td colspan="2" style="margin-left:5px; text-align:left"><h1>Occupancy Settings</h1></td>
            </tr>
            <tr>
                <th>&nbsp;</th>
            </tr>
            <tr>
                <td colspan="3">
                    <div style="margin-left:16px; text-align:left ">
                        Using the buttons below you are able to set the occupancy of your house. 
                        The occupancy state will have an effect on your heating zones that are set to follow occupancy. 
                    </div>
                </td>
            </tr>
            <tr>
