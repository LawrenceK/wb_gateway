...
<table>
    ...
    <tr>  
        	<wb:simpleButton wbTarget="/wbcmd/house1/SC/0"
        		wbSource="/wbsts/house1/DO/4">        	
        	Lights Off
        	</wb:simpleButton>

        	<wb:simpleButton wbTarget="/wbcmd/house1/DI/5">
        	Scene Up
        	</wb:simpleButton>

        	<wb:simpleButton wbTarget="/wbcmd/house1/DI/8">
        	Scene Down
        	</wb:simpleButton>
    ...
    <tr>
		...
		<td />
        <wb:simpleLink target="/template/kitchenDim">Direct Control</wb:simpleLink>
    </tr>
    <tr>
...
<table>
    ...
    <tr>  
        	...
        	<wb:simpleButton wbTarget="/wbcmd/house2/SC/0"
        		wbSource="/wbsts/house2/DO/4">        	
        	Lights Off
        	</wb:simpleButton>

        	<wb:simpleButton wbTarget="/wbcmd/house2/DI/5">
        	Scene Up
        	</wb:simpleButton>

        	<wb:simpleButton wbTarget="/wbcmd/house2/DI/8">
        	Scene Down
        	</wb:simpleButton>
    ...
    <tr>
        ...
        <wb:simpleLink target="/template/loungeDim">Direct Control</wb:simpleLink>
    </tr>
    <tr>
		<td width='80px' height='80px'
					wbType="FlashMeter" 
