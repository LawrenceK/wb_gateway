...
<table>
    ...
    <wb:textDisplay wbSource="/eventstate/zone${zoneNr}/state?attr=cmdsource">cmdsource
    </wb:textDisplay>
    ...
    <wb:numericDisplay wbSource="/eventstate/zone${zoneNr}/state?attr=minzonetemp" prefix="" format="##.#" postfix="&ordm;C">minZoneTemp
    </wb:numericDisplay>
    <wb:textDisplay wbSource="/eventstate/zone${zoneNr}/state?attr=enabled">Int enable
    </wb:textDisplay>
    <wb:textDisplay wbSource="/eventstate/zone${zoneNr}/state?attr=occupied">occupied
    </wb:textDisplay>
    <wb:textDisplay wbSource="/eventstate/zone${zoneNr}/state?attr=followoccupancy">followOccupancy
    </wb:textDisplay>
    <wb:textDisplay wbSource="/eventstate/zone${zoneNr}/state?attr=weathercompensation">weatherCompensation
    </wb:textDisplay>
    </div>
    </tr>
</table>
