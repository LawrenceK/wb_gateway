...
<span py:match="item.tag=='{http://id.webbrick.co.uk/}simpleLinkList'" py:strip="" >
        ...
        <div class="noniconbutton" >
            ...
            <div class="buttonlabel">
                <div class="buttonbodyoverlay">
                    <div class="buttonbodycontent" py:content="item.text"></div>
...
<span py:match="item.tag=='{http://id.webbrick.co.uk/}simpleLinkLarge'" py:strip="" >
    <div py:if="javascript == 'yes'"
                onClick="window.location=&apos;${item.get('target')}&apos;" 
                class="icon78pxitem" 
                id="${item.get('id')}"
    ...
    <div py:if="javascript == 'no'"
        ...
        <a href="${item.get('target')}">
            ...
            <div class="vertlabel">${item.text}</div>
        </a>
    </div>
</span>

<span py:match="item.tag=='{http://id.webbrick.co.uk/}textDisplayButton'" py:strip="" >
    <div  py:if="javascript == 'yes'"
            class="noniconbutton" >
        <img class="noniconbuttonleft" src="/static/activeskin/images/button/buttonleft.png"/>
        <div class="buttonlabel">
...
<span py:match="item.tag=='{http://id.webbrick.co.uk/}numericDisplayButton'" py:strip="" >
    <div  py:if="javascript == 'yes'"
            class="noniconbutton" >
        <img class="noniconbuttonleft" src="/static/activeskin/images/button/buttonleft.png"/>
        <div class="buttonlabel">
...
<span py:match="item.tag=='{http://id.webbrick.co.uk/}numericEntryButton'" py:strip="" >
    <div class="noniconbutton" >
        <div py:if="javascript == 'yes'"
            ...
            <div class="buttonlabel">
                <div class="buttonbodyoverlay">
                    <div class="buttonbodycontent"
                        py:content=" '%s%s%s' % ( item.get('prefix'), getCurrentValue( item.get('wbSource') ), item.get('postfix') )">
                    </div>
                    <img class="buttoncap" src="/static/activeskin/images/button/buttonright2.png"/>
                </div>
            </div>
        </div>
    </div>
...
<span py:match="item.tag=='{http://id.webbrick.co.uk/}timeDisplayButton'" py:strip="" >
    <div  py:if="javascript == 'yes'"
            class="noniconbutton" >
        <img class="noniconbuttonleft" src="/static/activeskin/images/button/buttonleft.png"/>
        <div class="buttonlabel">
...
<span py:match="item.tag=='{http://id.webbrick.co.uk/}onoffEntryButton'" py:strip="" >
    <div class="noniconbutton" >
        <div py:if="javascript == 'yes'"
                wbType="WbOnOffEntry" 
                wbTitle="${item.get('wbTitle')}"
                ...
                height="${item.get('height')}"
                baseClassName="${item.get('baseClassName')}"
                class="${item.get('baseClassName') or 'WbOnOffEntry'}Pending"
                >
            <img class="noniconbuttonleft" src="/static/activeskin/images/button/buttonleft.png"/>
            <div class="buttonlabel">
                <div class="buttonbodyoverlay">
                    <div class="buttonbodycontent" py:content="getCurrentValue( item.get('wbSource') )">Ignore</div>
                    <img class="buttoncap" src="/static/activeskin/images/button/buttonright2.png"/>
                </div>
            </div>
        </div>
    ...
    <span py:if="javascript == 'no'"
                ...
                height="${item.get('height')}"
                baseClassName="${item.get('baseClassName')}"
                class="${item.get('baseClassName') or 'WbOnOffEntry'}"
                py:content="getCurrentValue( item.get('wbSource') )"
    >Ignore</span>
</span>
...
<span py:match="item.tag=='{http://id.webbrick.co.uk/}dayEntryButton'" py:strip="" >
    <div class="noniconbutton" >
        <div py:if="javascript == 'yes'"
                wbType="WbDayEntry" 
                wbTitle="${item.get('wbTitle')}"
    ...
    <span py:if="javascript == 'no'"
                ...
                height="${item.get('height')}"
                baseClassName="${item.get('baseClassName')}"
                class="${item.get('baseClassName') or 'numeric'}display"
                py:content="getCurrentValue( item.get('wbSource') )"
    >-------</span>
</span>
...
<span py:match="item.tag=='{http://id.webbrick.co.uk/}enableEntryButton'" py:strip="" >
    <div py:if="javascript == 'yes'"
            ...
            height="${item.get('height')}"
            baseClassName="${item.get('baseClassName')}"
            class="${item.get('baseClassName') or 'WbEnableEntry'}Pending"
            stateVals="${item.get('stateVals')}"
        ...
        <div class="buttonlabel">
            <div class="buttonbodyoverlay">
                <div class="buttonbodycontent"
                    py:content="[item.get('prefix')]+[item.get('postfix')]">
                </div>
            </div>
            <img class="buttoncap" src="/static/activeskin/images/button/buttonright2.png"/>
        </div>
